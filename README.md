...
| <a name="input_username"></a> [username](#input\_username) | The username of kafka service | `string` | n/a | yes |
| <a name="input_password"></a> [password](#input\_password) | The password of kafka service. | `string` | n/a | yes |
